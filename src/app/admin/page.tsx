...
export default function AdminPage() {
  ...
  const [formCategory, setFormCategory] = useState<string>('Electronic');
  ...
  // Fetch catalogue when authenticated
  ...
  const filteredProducts = products.filter(p => {
    if (adminCategory !== 'all' && p.category.toLowerCase() !== adminCategory.toLowerCase()) {
      return false;
    }
    if (adminSearch.trim()) {
  ...
  // -------------------------------------------------------------
  // LOGIN SCREEN VIEW (When not authenticated)
  // -------------------------------------------------------------
  if (!isAuthenticated) {
    return (
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="Enter Admin ID (e.g. admin1)"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <div className="min-w-0">
              <span className="font-extrabold text-sm sm:text-base tracking-tight block truncate">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-6 sm:space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-2xs flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-[11px] font-bold text-gray-500 uppercase">Featured Items</p>
          ...
          <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-2xs flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-[11px] font-bold text-gray-500 uppercase">Out of Stock</p>
              <p className="text-xl font-black text-gray-900">{stats.unavailableProducts}</p>
            </div>
          </div>

        </div>

        {/* PRODUCTS MANAGEMENT BAR */}
        ...
        {/* 
          ...
          ==================================================
          Mobile: Stacked Card Rows (NO HORIZONTAL OVERFLOW!)
          Desktop: Data Table
          ==================================================
        */}

        {/* 1. MOBILE STACKED CARDS VIEW (Visible on < md screens) */}
        <div className="block md:hidden space-y-4">
          {isLoading ? (
            ...
            filteredProducts.map((p) => (
              <div
                key={p.id}
                className="bg-white rounded-2xl border border-gray-200 p-4 shadow-2xs space-y-3 relative"
              >
        ...
        {/* 2. DESKTOP DATA TABLE VIEW (Visible on >= md screens) */}
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g. LIGHTNING DEAL, HOT ITEM"
                    className="w-full px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-hidden focus:ring-2 focus:ring-brand-500 focus:bg-white"
                  />
                </div>
              </div>

              {/* Prices: Current vs Original */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-xs font-bold text-gray-700 uppercase mb-1">
                    Current Deal Price (₹) *
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 space-y-1.5">
                    ...
                    <input
                      ...
                      placeholder="Or paste image URL (Unsplash, Amazon, etc.)"
